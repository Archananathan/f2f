...
import logo from '../components/images/Logo.jpg';  // Import the company logo
import contactImage from '../components/images/contact.webp';  // Import the contact image
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          navigate('/IndustryContact'); // Redirect after successful submission//      
          } else {
        ...
        navigate('/IndustryContact'); // Redirect even in case of failure
      }
    };
