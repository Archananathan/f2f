...
import { faCogs, faTractor, faUserFriends } from '@fortawesome/free-solid-svg-icons';
...
import relianceLogo from './images/NS.avif';
import nilonsLogo from './images/saahas.webp';
import metroLogo from './images/coastel.webp';
import motherDairyLogo from './images/diamond.jpeg';
...
const Banner = () => {
  ...
  const setting = {
    ...
    autoplaySpeed: 3000, // Set the speed of the autoplay in milliseconds
    responsive: [
      {
        breakpoint: 1024,
        settings: {
        ...
        <section className='about-content'>
          ...
          <div className='about-section reverse'>
            <div style={textContainerStyle}>
              <h2 style={{color:"#1B5E20"}}>Infrastructure and Technology</h2>
              <h3 style={{color:"#4E342E"}}>Infrastructure</h3>
              <p>
              ...
              <h3 style={{color:"#4E342E"}}>Technology</h3>
              <p>
