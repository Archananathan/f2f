...
import cottonStem from './images/cottonstem.png';
...
import cottonFlower from './images/cottonflower.jpeg';
          ...
          <div className='product-container'>
            ...
            <div className='product-grid'>
              <div className="card">
                ...
                <Link to='/UserLogin'><button className="book-now">Sell</button></Link>
              </div>
              <div className="card">
                <h3>Coconut Shell</h3>
